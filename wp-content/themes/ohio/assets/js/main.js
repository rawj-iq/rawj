jQuery(function ($) {
    ...
    */
            ...
            if ($thisbutton.is('.single_add_to_cart_button')) {
                ...
                $.post(wc_add_to_cart_params.ajax_url, data, function (response) {
                    ...
                    if (wc_add_to_cart_params.cart_redirect_after_add === 'yes') {
                        ...
                        $('footer').before('<div class="ajax-cart-response message-box woo-message-box success">' + productName + ' ' + ohioVariables.add_to_cart_message + '<a class="view_cart_button" href="' + ohioVariables.cart_page + '">' + ohioVariables.view_cart + '</a><div class="btn-round btn-round-small btn-round-light clb-close" tabindex="0"><i class="ion ion-md-close"></i></div></div>');
                    }
                });
                return false;
            } else {
    ...
    $(window).on('load', function () {
        ...
        $('#page-preloader, .container-loading').addClass('hidden');
        $('.gimg').css('opacity', '1');
