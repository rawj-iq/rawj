...
function ohio_enqueue_own_styles() {
    ...
    wp_register_style('ohio-shortcodes-settings', false);
    wp_enqueue_style('ohio-shortcodes-settings');
    wp_add_inline_style('ohio-shortcodes-settings', OhioLayout::get_shortcodes_css_buffer(false));
